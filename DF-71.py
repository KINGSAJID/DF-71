...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-Darkforce-\033[1;95m♡╭──────────•◈•──────────╮♡
...
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mdarkforce\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  ...
  \033[1;96m ─────────────•◈•──────────  
   ...
   \033[1;92m███████▒▒Welcome To Darkforce▒▒████████
...
\033[1;94mFacebook\033[1;91m: \033[1;91memonahmed

\033[1;94mWhatsapp\033[1;91m: \033[1;91m+8801649106892

\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mBlackMafia\033[1;95m♡╰──────────•◈•──────────╯♡"""

jalan('              \033[1;96m....................DarkForce.....................:')
...
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin DarkForce\033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "darkforce"

CorrectPassword = "darkforce"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev:dark_force
...
def menu():
	...
	os.system("clear") #Dev:dark_force
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mDarkForce\033[1;95m♡──────────•◈•──────────♡"
...
: \033[1;96m .....emonahmed  DarkForce........... \033[1;93m :
